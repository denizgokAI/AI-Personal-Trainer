...
def findAngle(img, p1, p2, p3, lmList, draw=True):
    ...
    if draw:
        ...
        if is_running:
            ...
            if current_exercise == "CURL" and angle < 50: threshold_met = True
...
while True:
    ...
    if results.pose_landmarks:
        ...
        if len(lmList) != 0:
            ...
            # --- DÜZELTİLMİŞ TOLERANS (160 YERİNE 140) ---
            if current_exercise == "SQUAT":
                target_min, target_max = 80, 140  # Kalkan bacak açısı esnetildi
                if current_side == "RIGHT":
                    idx_1, idx_2, idx_3 = 23, 25, 27
                else:
                    idx_1, idx_2, idx_3 = 24, 26, 28

            elif current_exercise == "CURL":
                target_min, target_max = 50, 140  # Kalkan kol açısı esnetildi
                if current_side == "RIGHT":
                    idx_1, idx_2, idx_3 = 11, 13, 15
                else:
